...
const BANK_DATA = {
  NACIONAL: [
    { id: 'banco-venezuela', name: 'Banco de Venezuela', logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Banco_de_Venezuela_logo.svg/320px-Banco_de_Venezuela_logo.svg.png' },
    { id: 'banco-venezolano', name: 'Banco Venezolano de Crédito', logo: 'https://www.venezolano.com/images/galeria/108_1.png' },
    { id: 'banco-mercantil', name: 'Banco Mercantil', logo: 'https://upload.wikimedia.org/wikipedia/commons/7/75/Mercantil_logo_2015.png' },
    ...
    { id: 'banco-banesco', name: 'Banesco', logo: 'https://upload.wikimedia.org/wikipedia/commons/8/83/Banesco_logo.png' },
    ...
    { id: 'banco-activo', name: 'Banco Activo', logo: 'https://upload.wikimedia.org/wikipedia/commons/7/70/Banco_Activo_logo.png' },
    ...
    { id: 'banco-bnc', name: 'Banco Nacional de Crédito', logo: 'https://upload.wikimedia.org/wikipedia/commons/4/44/Banco_Nacional_de_Credito_logo.png' },
